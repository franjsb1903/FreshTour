...
SET prezo = 4,
    prezo_reducido = 4,
    horario = 'Todos os días de 11:00-19:00 (xuño a outubro 10:00 a 20:00)',
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Lugar público, sen horario',
...
SET prezo = 2.4,
    prezo_reducido = 1.2,
    horario = 'Martes a venres, de 9:30 a 20:30. Sábados de 11:00 a 19:30. Domingos e festivos, de 10:15 a 14:45.',
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Luns a domingo de 8:00 a 20:00',
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Todos os días, de 8:00 a 15:00',
    comentario_visita_lenta = 'Na visita lenta, recoméndase encarecidamente unha visualización pausada da arquitectura do mercado, así como deterse a observar os distintos postos e tendas que o compoñen, con cociña típica da zona e produtos frescos.',
    comentario_visita_rapida = 'Na visita rápida, recoméndase unicamente a visualización da arquitectura do mercado, incluíndo se se desexan ver os postos rapidamente.',
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Sen horario. Misa ás 19:30 todos os días.',
    comentario_visita_lenta = 'Inclúese nesta visita a visualización da súa fachada exterior e do seu interior dun xeito pausado e tranquilo, parándose en todos os detalles que ten esta Igrexa construída a carón da Catedral.',
    comentario_visita_rapida = 'Na visita rápida, recoméndase a visualización da súa fachada exterior e botar unha ollada ao seu interior, merecendo deste xeito moito a pena.',
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Sen horario.',
    comentario_visita_lenta = 'Na visita lenta, recoméndase unha visita pausada por cada un dos catro patios que compoñen o Hostal, xunto ca súa capela situada no medio dos patios, declarada Monumento Nacional en 1912.',
    comentario_visita_rapida = 'Na visita rápida, recoméndase unicamente a visita ao primeiro dos patios, sendo este o máis artístico dos catro, así como da capela do Hostal.',
    tempo_visita_lenta = 60,
...
SET prezo = 0,
    prezo_reducido = 0,
    horario = 'Todos os días, de 9:00 h a 20:30 h.',
    comentario_visita_lenta = 'Na visita lenta, recoméndase a visualización íntegra da Catedral de Santiago de Compostela, visitando todo o seu interior e subindo á súa parte superior, xa aberta de novo ao público. Tamén se inclúe nesta visita a visualización detida do seu exterior completamente reformado, momento idóneo para sacar fotografías.',
    comentario_visita_rapida = 'Con respecto á visita rápida, recoméndase neste caso a visita rápida do interior da Catedral, sen deterse demasiado nos seus múltiples detalles, e subir á súa parte superior, ademáis de contemplar a súa parte exterior.',
...
SET prezo = 6,
    prezo_reducido = 4,
    horario = 'Luns a venres, 10:00 a 19:15. Fins de semana, de 10:00 a 14:00 e de 16:00 a 19:15.',
    comentario_visita_lenta = 'Na visita lenta, recoméndase unha visita tranquila e pausada polo interior do Pazo, observando todas as súas características históricas e arquitectónicas que o conforman.',
    comentario_visita_rapida = 'Na visita rápida, recoméndase unha visita sen pararse en exceso nas características arquitectónicas principais do Pazo, simplemente visualizando as súas diferentes salas.',
    tempo_visita_lenta = 60,
    tempo_visita_rapida = 30,
...
select name as titulo,
    current_timestamp,
    current_timestamp,
    'healthcare' as main_tag,
    way as geom,
    'clinic' as sub_tag
from osm_outras_actividades.planet_osm_point pop
where shop is null and tourism is null and public_transport is null and amenity is null;