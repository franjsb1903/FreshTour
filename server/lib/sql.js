...
sql.usuarios.get.plansFav = "SELECT *, 'Planificación' as tipo, true AS favorito FROM fresh_tour.planificacions p2 WHERE id IN ( SELECT id_planificacion FROM fresh_tour.planificacions_favoritas pf WHERE id_usuario = $1)";
